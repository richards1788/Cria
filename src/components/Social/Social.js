...
export const Social = () => {
    return (
        <div className="float">
            <a href="https://api.whatsapp.com/send?phone=+573142881362" rel="noopener noreferrer" target="_blank" class="float">
                <span role="img"
                    aria-label="whats-app"
                    size="40"
                    class="anticon anticon-whats-app">
                    <svg viewBox="64 64 896 896"
                        focusable="false"
                        class="" data-icon="whats-app"
